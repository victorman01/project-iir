...
{
	$con = mysqli_connect("localhost","root","","kamus_porter");
	...
	foreach($pecah as $word)
	{
		...
		$partikel = mysqli_query($con,"SELECT * FROM dsr_partikel WHERE name ='$word'");
		...
		//langsung tulis
		    ...
		    $partikel_berprefiks=mysqli_query($con,"SELECT * FROM dsr_partikel_prefiks WHERE name='$word'");
		...
		$milik = mysqli_query($con,"SELECT * FROM dsr_milik WHERE name='$word2'");
		...
		//langsung tulis
		  ...
		  $milik_berprefiks = mysqli_query($con,"SELECT * FROM dsr_milik_prefiks WHERE name='$word2'");
		...
		$prefiks1 = mysqli_query($con,"SELECT * FROM dsr_prefiks1 WHERE name='$word3'");
		...
		//langsung tulis
		   ...
		   $prefiks1_sufiks = mysqli_query($con,"SELECT * FROM dsr_prefiks1_sufiks WHERE name='$word3'");
		...
		$prefiks2 = mysqli_query($con,"SELECT * FROM dsr_prefiks2 WHERE name='$word4'");
		...
		$prefiks2_sufiks = mysqli_query($con,"SELECT * FROM dsr_prefiks2_sufiks WHERE name='$word4'");
		...
		$sufiks = mysqli_query($con,"SELECT * FROM dsr_sufiks WHERE name='$word5'");
		$prefiks2_sufiks = mysqli_query($con,"SELECT * FROM dsr_prefiks2_sufiks WHERE name='$word5'");
		if(mysqli_num_rows($sufiks)==1){
		//langsung tulis
			$dasar =$word5; 
			$hasil = $hasil." ".$dasar;
			array_push($hasil,$dasar);
			//exit;
		}else{
		  //hapus sufiks
